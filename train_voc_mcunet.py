...
def get_args():
    ...
    parser.add_argument("--mcunet_config_path", type=str, default="mcunet/assets/configs/mcunet-5fps_imagenet.json",
                        help="Path to the MCUNet config JSON")
    ...
    parser.add_argument("--pre_trained_model_type", type=str, choices=["params", "scratch"], default="params")
    parser.add_argument("--pre_trained_model_path", type=str, default="trained_models/whole_model_trained_yolo_voc")
    parser.add_argument("--log_path", type=str, default="tensorboard/yolo_voc_mcunet")
